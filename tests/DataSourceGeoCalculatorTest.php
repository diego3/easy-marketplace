...
class DataSourceGeoCalculatorTest extends TestCase {
    ...
    public function testDistance(){
        ...
        $res = $calculator->distance($home->lat, $home->long, $palladium->lat, $palladium->long, 'K');
        ...
        $res = $calculator->distance($home->lat, $home->long, $terminal->lat, $terminal->long, 'K');
        ...
        $res = $calculator->distance($home->lat, $home->long, $barigui->lat, $barigui->long, 'K');
        // google maps = 10.77km
